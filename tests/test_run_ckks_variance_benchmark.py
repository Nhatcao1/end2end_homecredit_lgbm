...
from code.heir.scripts.run_ckks_variance_benchmark import raise_square_context_budget
...
class RunCkksVarianceBenchmarkTest(unittest.TestCase):
    ...
    def test_context_patch(self) -> None:
        patched, original = raise_square_context_budget("params.SetMultiplicativeDepth(1);", 12)
