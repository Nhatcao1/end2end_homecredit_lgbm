...
def main() -> None:
    ...
    parser.add_argument("--generated-dir", type=Path, required=True); parser.add_argument("--prepared-dir", type=Path, default=Path("data/prepared/installments_columns")); parser.add_argument("--value-count", dest="value_counts", nargs="+", type=int, default=[1000, 5000]); parser.add_argument("--input-scale", type=float, default=0.0); parser.add_argument("--repetitions", type=int, default=5); parser.add_argument("--ckks-mul-depth", type=int, default=6); parser.add_argument("--relative-tolerance", type=float, default=1e-5); parser.add_argument("--output-dir", type=Path, required=True); parser.add_argument("--openfhe-dir", default="/usr/local/lib/OpenFHE"); parser.add_argument("--overwrite", action="store_true")
